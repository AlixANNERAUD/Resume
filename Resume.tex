...
\begin{paracol}{2}
  ...
  {}
  {}
  Implemented a research paper by one of our professors, focusing on evidential occupancy grid mapping (EOGM).
  Developed the solution in C++ on the ROS platform, incorporating memory optimizations, parallelization, and vectorization techniques.
  
  For more projects, please visit my GitHub and website.
