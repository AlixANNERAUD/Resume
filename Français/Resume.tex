...
\begin{document}
\name{Alix ANNERAUD}
\tagline{Passionné d'informatique et de technologies}
...
\begin{paracol}{2}
  ...
  \begin{quote}
    \small
    ``Actuellement en \textbf{pause académique}, je recherche un \textbf{poste à temps plein} pour mettre en pratique mes compétences et contribuer au sein d'une équipe.``
  \end{quote}
  ...
  4ème année validée - Reprise en septembre 2026 avec possibilité d'\textbf{alternance}.
