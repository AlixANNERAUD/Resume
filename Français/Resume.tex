...
\end{itemize}
  ...
  \cvevent{Xila}{\url{https://xila.dev}}{}{}
    ...
    Réécriture partielle en Rust pour améliorer performances et sécurité.
  ...
  En nous basant sur un article de notre professeur sur la théorie de Dempster-Shafer en robotique, nous avons développé un algorithme en temps réel pour cartographier les espaces libres et occupés avec LiDAR, IMU et GPS.
  Cet algorithme, développé pour ROS en C++, a été optimisé pour la vitesse et l'efficacité grâce à des techniques de gestion de mémoire, de vectorisation et de parallélisation.
  \medskip
