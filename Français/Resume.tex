...
\begin{document}
\name{Alix ANNERAUD}
\tagline{Étudiant-ingénieur en informatique -- Contrat pro 1 an (2/3 j) dès sept. 2026}
...
\begin{paracol}{2}
  ...
  \cvevent{Technicien réseau et télécoms}{\href{https://linkt.fr/}{Linkt}}{Décembre 2025 -- Aôut 2026}{Mont-Saint-Aignan, France}
  Résolution d'incidents sur architectures multi-technos (FTTO, 4G, Sat) et interconnexions VPN IP avec gestion de la haute disponibilité (GTR, actif/passif).
  Configuration d'équipements multi-marques (Cisco, Fortinet) et solutions VoIP.
  Développement proactif d’une extension WXT/Vue.js pour optimiser le workflow opérationnel.
  ...
  \cvevent{Assistant relations entreprises -- INSA Rouen}{}{Sept. 2021 -- Juin 2024}{}
  \vspace{-0.5em}
  ...
  \begin{minipage}[t]{0.49\linewidth}
    ...
    \cvevent{\normalsize ThéraPIC -- Chef de projet - \underline{\href{https://www.becquerel.fr/}{CHB}}}{}{}{}
    {\small \cvtag{Vue.js}\cvtag{Django}\cvtag{PostgreSQL}\cvtag{NLP}\cvtag{Docker} - Pilotage d'une équipe agile de 6 personnes (~20h/sem.) pour une app full-stack de gestion des prescriptions au Centre Henri Becquerel.}
  \end{minipage}
  \hfill
  \begin{minipage}[t]{0.49\linewidth}
  ...
  \begin{quote}
    ``Ingénieur logiciel avec 2 stages internationaux, expertise en systèmes bas niveau, cloud AWS et développement full-stack. \textbf{1\textsuperscript{er}} Jeanne d'Hack CTF 2026 \& Cod'INSA 2025. Recherche un \textbf{contrat de professionnalisation} (septembre 2026).''
  \end{quote}
  ...
  Bac+4 validé (éq. M1) -- reprise en septembre 2026, ouvert à l'\textbf{alternance}.
  ...
  \cvtag{Sens des responsabilités}
  \cvtag{Ténacité}
  \cvtag{Permis B}
  \\
