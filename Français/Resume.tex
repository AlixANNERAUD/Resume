...
\begin{paracol}{2}
  ...
  \begin{quote}
    ``Ingénieur logiciel avec 2 stages internationaux et une expertise en systèmes bas niveau, cloud AWS et développement full-stack. Recherche un \textbf{contrat de professionnalisation} (septembre 2026) pour contribuer à des projets techniques challengeants.''
  \end{quote}
