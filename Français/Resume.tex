...
\begin{document}
\name{Alix ANNERAUD}
\tagline{Développeur et élève-ingénieur en informatique de 22 ans}
...
\begin{paracol}{2}
  ...
  \begin{quote}
    \small
    ``À la recherche d'un \textbf{poste en informatique à temps plein} pour mettre en pratique mes compétences techniques sur des projets innovants.``
  \end{quote}
