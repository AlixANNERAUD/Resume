...
\begin{document}
\name{Alix ANNERAUD}
\tagline{Étudiant-ingénieur en informatique -- Alternance recherchée dès septembre 2026}
...
\begin{paracol}{2}
  ...
  Résolution d'incidents réseau (VPN MPLS, VRRP, FTTH/xDSL/4G) avec SLA < 4h. Configuration routeurs Cisco/Keenetic, pare-feu Fortinet, VoIP (SIP, Centrex). Extension navigateur (WXT/Vue.js) pour automatiser diagnostics et tickets.
